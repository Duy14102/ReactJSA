        ...
        <div className="container-xxl py-5">
            <div className="container">
                <div className="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h5 className="section-title ff-secondary text-center text-primary fw-normal">Feedback</h5>
                    <h1 className="mb-5">Tell us what you feel :)</h1>
                </div>
                        ...
                        <div className="wow fadeInUp" data-wow-delay="0.2s">
                            <form onSubmit={(e) => addcontact(e)}>
                                <div className="row g-3">
                                        ...
                                        <>
                                            <div className="col-md-6">
                                                <div className="form-floating">
                                                    <input onChange={(e) => setContactState({ name: e.target.value })} type="text" className="form-control" id="name" placeholder="Your Name" required />
                                                    <label htmlFor="name">Your Name</label>
                                                </div>
                                            </div>
                                            <div className="col-md-6">
                                                <div className="form-floating">
                                                    <input onChange={(e) => setContactState({ email: e.target.value })} type="email" className="form-control" id="email" placeholder="Your Email" required />
                                    ...
                                    <div className="col-12">
                                        <div className="form-floating">
                                            <input onChange={(e) => setContactState({ title: e.target.value })} type="text" className="form-control" id="subject" placeholder="Title" required />
                                            <label htmlFor="subject">Title</label>
                                        </div>
                                    </div>
                                    <div className="col-12">
                                        <div className="form-floating">
                                            <textarea onChange={(e) => setContactState({ message: e.target.value })} className="form-control" placeholder="Leave a message here" id="message" style={{ height: 150 + "px" }} required></textarea>
                                            <label htmlFor="message">Message</label>
                                        </div>
                                    </div>
                                    <div className="col-12">
                                        <button className="btn btn-primary w-100 py-3" type="submit">Send feedback</button>
                                    </div>
                                </div>
                            </form>
                        </div>
