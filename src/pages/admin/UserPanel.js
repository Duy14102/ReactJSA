...
function UserPanel() {
    ...
    }, [socketState.newOrder, socketState.cancelOrder, socketState.orderComplete, socketState.cancelByMag, socketState.bookingDeny, socketState.changeTable, socketState.checkoutBook])
                    ...
                    <div className="coverUser">
                        ...
                        <div style={{ padding: "2%" }}>
                            ...
                            <div className="UPanelButton" id="Hum">
                                <UserDataPanel Data={updateState.GetOrder} toke={name} />
                            </div>
