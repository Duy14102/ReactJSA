                            ...
                            <form onSubmit={(e) => handleSubmit(e, appler.id)}>
                                ...
                                <div className="BossLvMax" style={{ padding: "2%" }}>
                                    ...
                                    {Object.values(GetUser).map((i) => {
                                        return (
                                            <Fragment key={i._id}>
                                                <div style={{ pointerEvents: Edit ? "auto" : "none" }} className="profile-pic-wrapper okImFirst">
                                                    ...
                                                    <div className="d-flex justify-content-between align-items-center">
                                                        ...
                                                        {Edit ? (
                                                            <div className="anotherJackass2">
                                                                <button type="button" className="btn btn-danger text-nowrap" onClick={() => setModalOpenDetail(true)}>Delete account</button>
                                                            </div>
                                                        ) : null}
                                                    </div>
                                                </div>
                    ...
                    <form onSubmit={(e) => DeleteAcount(e)} className="py-3" style={{ display: "flex", flexDirection: "column", gap: 30 }}>
                        ...
                        <div className="d-flex justify-content-center flex-column align-items-center">
                            <div className="deleteAccountInputField">
                                <input onChange={(e) => setDeletePassword(e.target.value)} style={{ width: navigator.userAgent.indexOf('Safari') !== -1 && navigator.userAgent.indexOf('Chrome') === -1 ? "80%" : "90%", fontSize: 25, border: "none", padding: 5 }} type={seePassword ? "text" : "password"} required />
                                {seePassword ? (
                                    <button className="EyeInDeleteAccountField" type="button" style={{ width: navigator.userAgent.indexOf('Safari') !== -1 && navigator.userAgent.indexOf('Chrome') === -1 ? "20%" : "10%", textAlign: "center" }} onClick={() => setSeePassword(false)}>
                                    ...
                                    <button className="EyeInDeleteAccountField" type="button" style={{ width: navigator.userAgent.indexOf('Safari') !== -1 && navigator.userAgent.indexOf('Chrome') === -1 ? "20%" : "10%", textAlign: "center" }} onClick={() => setSeePassword(true)}>
