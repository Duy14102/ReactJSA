                    ...
                    <div className="wrap-login100">
                        <form onSubmit={(e) => handleSubmit(e)} className="login100-form validate-form">
                            ...
                            <div className="wrap-input100 validate-input" data-validate="Enter password">
                                ...
                                <input className="input100 showpassInp1" type="password" name="password" value={password} onChange={(e) => setPassword(e.target.value)} />
                            ...
                            <div className="wrap-input100 validate-input" data-validate="Repeat password">
                                ...
                                <input className="input100 showpassInp2" type="password" name="password" value={confirm} onChange={(e) => setConfirm(e.target.value)} />
